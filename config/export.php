...
return [
     ...
     */
    /*
     * The crawler starts at "/", which is only a redirect to the default
     * locale — it can't discover the other languages from there. Seeding it
     * with each locale root is enough: the taskbar language switcher and
     * the project cards link everything else together from those.
     */
    'paths' => ['en', 'fr', 'ar'],
     ...
     */
    'before' => [
        // always ship freshly built CSS/JS rather than whatever was last
        // left in public/build from local development
     ...
     */
    'after' => [
        // route()/asset() bake APP_URL into every link; strip it so the
        // build is domain-agnostic (see App\Console\Commands\RelativizeExport)
        'relativize' => 'php artisan export:relativize',
    ],
